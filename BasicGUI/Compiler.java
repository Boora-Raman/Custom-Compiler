...
public class Compiler {
    ...
    public List<Token> tokens;  // Made public for GUI access
    private int pos;
    public List<String> errors;  // Made public for GUI access
    ...
    public void tokenize() {  // Made public
        int line = 1;
        int column;
    ...
    public ASTNode parse() {  // Made public
        tokenize();
    ...
    public static void main(String[] args) {
        // Launch GUI instead of command-line version
